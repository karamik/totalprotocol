...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/1f6e1.png" width="150" alt="TOTAL Protocol Shield" />
</p>
...
**TOTAL Protocol** (Sentinel) is the first Layer 2 (L2) infrastructure powered by hybrid **PC + FPGA hardware acceleration**. 
