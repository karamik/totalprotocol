...
<p align="center">
  <img src="https://files.catbox.moe/k699f7.png" width="400" alt="TOTAL Protocol Logo" />
</p>
...
**TOTAL Protocol** (Sentinel) is the first Layer 2 (L2) infrastructure powered by hybrid **PC + FPGA hardware acceleration**. We eliminate the gap between blockchain throughput and security by moving protection from software to hardware-enforced invariants.
